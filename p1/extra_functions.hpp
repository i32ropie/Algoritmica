 ...
 * @brief <Práctica 1> Funciones extra.
...
/**
 * @brief Función que devuelve un número aleatorio entre -10 y 10
 * @note El número generado tendrá un máximo de 4 decimales.
 * @return Número aleatorio entre -10 y 10.
 */
